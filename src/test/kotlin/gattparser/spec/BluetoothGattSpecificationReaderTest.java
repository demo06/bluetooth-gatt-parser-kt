...
public class BluetoothGattSpecificationReaderTest {
    ...
    public void testGetBasicCharacteristic() throws Exception {
        ...
        assertNotNull(value);
        assertNull(FlagUtils.INSTANCE.getFlags(value.getFields()));
    ...
    public void testGetCharacteristic() throws Exception {
        ...
        assertEquals(fields.get(0), FlagUtils.INSTANCE.getFlags(value.getFields()));
    ...
    public void testGetFlags() {
        Characteristic characteristic = reader.getCharacteristicByUUID("2A1C");
        Set<String> flags = FlagUtils.INSTANCE.getAllFlags(FlagUtils.INSTANCE.getFlags(characteristic.getValue().getFields()));
    ...
    public void testGetRequirements() {
        ...
        Field flags = FlagUtils.INSTANCE.getFlags(fields);
        ...
        flags = FlagUtils.INSTANCE.getFlags(fields);
